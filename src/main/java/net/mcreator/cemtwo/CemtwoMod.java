...
@Mod("cemtwo")
public class CemtwoMod {
	public static final Logger LOGGER = LogManager.getLogger(CemtwoMod.class);
	public static final String MODID = "cemtwo";
